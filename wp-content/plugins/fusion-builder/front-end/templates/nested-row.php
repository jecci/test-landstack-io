...
<script type="text/template" id="fusion-builder-row-inner-template">
	...
	<div class="fusion-builder-editing-icons">
		...
		<a href="#" class="fusion-builder-row-settings fusion-builder-module-control"><span class="fusiona-pen"></span><span class="fusion-element-tooltip"><span class="fusion-tooltip-text"><?php esc_html_e( 'Open Row Settings', 'fusion-builder' ); ?></span></span></a>
