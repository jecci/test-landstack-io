	...
	class FusionBuilder_Woocommerce {
		...
		public function rollover_buttons_linebreak() {
			...
			<?php if ( $product && ( ( $product->is_purchasable() && $product->is_in_stock() ) || $product->is_type( 'external' ) ) ) : ?>
				<?php $button_delimiter = 'clean' === Avada()->settings->get( 'woocommerce_product_box_design' ) ? '/' : ''; ?>
				<?php $button_delimiter = apply_filters( 'awb_rollover_button_delimiter', $button_delimiter ); ?>
