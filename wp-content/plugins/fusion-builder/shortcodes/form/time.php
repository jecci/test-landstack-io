			...
			[
				...
				'params'         => [
					...
					[
						...
						'description' => esc_attr__( 'Choose to enable a lightweight custom picker either on desktop only or on all devices. Set to "never" to use the browser native picker.', 'fusion-builder' ),
						'param_name'  => 'picker',
						'default'     => 'custom',
						'value'       => [
