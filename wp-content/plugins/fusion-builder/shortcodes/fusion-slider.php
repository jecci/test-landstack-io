		...
		fusion_builder_frontend_data(
			...
			[
				...
				'params'            => [
					...
					[
						'type'             => 'textarea',
						'heading'          => esc_attr__( 'Video Element or Embed Code', 'fusion-builder' ),
						'description'      => __( 'Click one of the buttons to insert the corresponding element, or paste your video embed code below. 
							<ul class="fusion-builder-all-modules" style="justify-content: start; margin: -8.5px; padding: 5px 0px;">
								<li class="fusion_vimeo fusion-builder-element insert-slider-video" style="padding-top: 0; padding-bottom: 0;" data-type="fusion_vimeo">
									<h4 class="fusion_module_title">
										<div class="fusion-module-icon fusiona-vimeo2"></div>'
										. esc_html__( 'Vimeo', 'fusion-builder' ) .
									'</h4>
									<span class="fusion_module_label">fusion_vimeo</span>
								</li>
								<li class="fusion_youtube fusion-builder-element insert-slider-video" style="padding-top: 0; padding-bottom: 0;" data-type="fusion_youtube">
									<h4 class="fusion_module_title">
										<div class="fusion-module-icon fusiona-youtube"></div>'
										. esc_html__( 'YouTube', 'fusion-builder' ) .
									'</h4>
									<span class="fusion_module_label">fusion_youtube</span>
								</li>
								<li class="fusion_video fusion-builder-element insert-slider-video" style="padding-top: 0; padding-bottom: 0;" data-type="fusion_video">
									<h4 class="fusion_module_title">
										<div class="fusion-module-icon fusiona-video"></div>'
										. esc_html__( 'Video', 'fusion-builder' ) .
									'</h4>
									<span class="fusion_module_label">fusion_video</span>
								</li>
							</ul>', 'fusion-builder' ),
						'param_name'       => 'video',
						'remove_from_atts' => true,
