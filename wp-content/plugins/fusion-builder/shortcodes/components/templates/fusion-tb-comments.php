...
<?php if ( have_comments() ) : ?>
	...
	<?php if ( 'show' === $defaults['headings'] ) : ?>
		<?php ob_start(); ?>
		<?php comments_number( esc_html__( 'No Comments', 'fusion-builder' ), esc_html__( 'One Comment', 'fusion-builder' ), sprintf( _n( esc_html__( '%s Comment', 'fusion-builder' ), esc_html__( '%s Comments', 'fusion-builder' ), get_comments_number() ), number_format_i18n( get_comments_number() ) ) ); ?>
