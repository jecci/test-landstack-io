        ...
        <form action="<?php echo esc_url(next3_admin_url( 'admin.php?page=next3aws'));?>" method="POST" class="nextactive-form" id="nextactive-form">
            ...
            <div class="ins-active-license">
                <?php if($status == 'active'){?>
                    <div class="nextactive-message"><a href="" class="__revoke_license" data-keys="<?php echo esc_attr($key_data);?>" > <?php echo esc_html__('Click to revoke license. ', 'next3-offload');?></a></div>
                <?php }else{?>
                    ...
                    <button type="submit" name="_active_license" class="next_active_license-button"><?php echo esc_html__('Activate license', 'next3-offload');?> </button>
                </div>
