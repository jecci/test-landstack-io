<?php
namespace Next3Offload\Modules\Providers\Digital;
...
class N3aws_Action{
    ...
    public function configration( $region = ''){
        ...
        if( empty($endpoint) ){
			$endpoint = 'https://' . $this->default_region . '.' . $this->default_domain;
        } /*else {
    ...
    public function get_access(){
        ...
        $config_data['default_region'] = ($this->settingData['default_region']) ?? 'nyc3';
    ...
    public function get_regions( $name = ''){
        ...
        $list = apply_filters('next3/regions/digital', [
            'nyc3' => 'New York',
            'ams3' => 'Amsterdam',
            'lon1' => 'London',
            'sgp1' => 'Singapore',
